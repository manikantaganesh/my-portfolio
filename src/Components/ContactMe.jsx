  ...
  sendMail(e, data) {
    ...
    if(this.state.contactDetails.name!=='' && this.state.contactDetails.name.trim() !== "" && this.state.contactDetails.email !== "" && this.state.contactDetails.email.trim() !== "" &&this.state.contactDetails.subject !== "" && this.state.contactDetails.subject.trim() !== "" && this.state.contactDetails.message !== "" && this.state.contactDetails.message.trim() !== ""){
      ...
      if(!emailRegex.test(req.from)) {
        ...
        emailjs.sendForm('service_foororz', 'template_5l218s9', this.state.current, 'VpUbd_pOc2tBI986F')
      .then((result) => {
        ...
        swal(`${error.text}`, "Something went wrong", "error")
        .then((value) => {
          window.location.reload()
        });
      });
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="card-body">
                        ...
                        <p className="pb-2">61-12/1-2, Salivahana street, Ramalingeswara Nagar, Krishna Lanka, Vijayawada, AP, India.</p>
                        <p className="mb-0"><strong>Phone</strong></p>
                        <p className="pb-2">+91 970-043-3987</p>
                        <p className="mb-0"><strong>Email</strong></p>
                        <p>manikantaganesh.nanduri@gmail.com</p>
                      </div>
                    </div>
                  </div>
                </div>
